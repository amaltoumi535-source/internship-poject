...
function DocumentsListView({ onSelectDoc }) {
    ...
    async function handleFileSelected(e) {
        ...
        setError(null);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].uploadDocument(file);
            setRefreshKey((k)=>k + 1);
        } catch (err) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/lib/api/client.ts [app-ssr] (ecmascript)");
;
const getReportsOverview = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get("/reports/overview");
const getDocReport = (documentId, sampleLimit = 3)=>__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/reports/doc/${documentId}?sample_limit=${sampleLimit}`);
const exportDocuments = (format = "json", limit = 1000, offset = 0)=>__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/reports/export?format=${format}&limit=${limit}&offset=${offset}`);
}),
];

//# sourceMappingURL=frontend_1bhn2id._.js.map